...
// Handle SPA routing: serve index.html for all navigation requests (allows offline navigation)
try {
  const handler = createHandlerBoundToURL('/index.html');
  const navigationRoute = new NavigationRoute(handler, {
    denylist: [/^\/_/, /\/[^/?]+\.[^/]+$/], // exclude URLs starting with /_ or those with file extensions
  });
